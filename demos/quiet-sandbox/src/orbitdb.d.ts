declare module "@orbitdb/core" {
  ...
  import type { HeliaLibp2p, IPFS } from "helia";
  ...
  export function Database(args: DatabaseArgs): Promise<Database>;
  ...
  export type KeyValue = {
    ...
    // export function Events(args: DatabaseArgs): Promise<Events>; 
}

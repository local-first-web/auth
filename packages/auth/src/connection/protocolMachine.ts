...
> = {
  ...
  states: {
          ...
          states: {
            initializing: {
              always: [
                ...
                { cond: 'bothHaveInvitation', actions: 'failNeitherIsMember', target: '#failure' },
    ...
    connected: {
      ...
      always: { cond: 'peerWasRemoved', actions: 'failPeerWasRemoved', target: 'disconnected' },
      ...
      on: {
        ...
        SYNC: { actions: ['receiveSyncMessage', 'onUpdated'], target: 'connected' },

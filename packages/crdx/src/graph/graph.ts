...
export const getHashes = (graph: Graph<any, any>) =>
  Object.keys(graph.links) as Hash[]

export const getLink = <A extends Action, C>(
  graph: Graph<A, C>,
  hash: Hash
): Link<A, C> => graph.links[hash]

export const getEncryptedLink = (graph: Graph<any, any>, hash: Hash) =>
  graph.encryptedLinks[hash]

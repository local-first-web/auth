...
This monorepo is setup for a dummy `@localfirst/` NPM organization. There are 2 packages by default:

- `@localfirst/react` - A placholder React component
- `@localfirst/utils` - A utils packages

Unlike other TSDX templates, the developer experience for this template is currently a bit more manual.

Your first order of business will be to search and replace `@localfirst` for the npm organization of your own.
